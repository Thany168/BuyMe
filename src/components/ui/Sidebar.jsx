  ...
  return (
    ...
    >
      ...
      <nav className="p-2 space-y-1">
        <SidebarItem to="/" label="Dashboard" collapsed={collapsed} icon={<DashboardIcon />} />
        <SidebarItem to="/products" label="Products" collapsed={collapsed} icon={<InventoryIcon />} />
        <SidebarItem to="/orders" label="Orders" collapsed={collapsed} icon={<ShoppingCartIcon />} />
      </nav>
    </aside>
  );
}
